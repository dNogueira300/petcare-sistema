...
import { proximaDosisDesdeFrecuencia, FRECUENCIA_LABEL, type Frecuencia } from "@/lib/vacunas";
...
export async function POST(req: NextRequest) {
  ...
  if (idVeterinario) {
    ...
    const detalleFrec = frecuencia ? `. Frecuencia: ${FRECUENCIA_LABEL[frecuencia as Frecuencia]}` : "";

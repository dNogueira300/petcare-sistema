        ...
        <div style={{ padding:"24px" }}>
          {done ? (
            <div style={{ textAlign:"center", padding:"8px 0" }}>
              ...
              <p style={{ fontFamily:"var(--font-dm-sans)", fontSize:"0.88rem", color:"#8a7a60", lineHeight:1.6, margin:"0 0 20px" }}>Tu mascota fue registrada. Ya puedes agendar una cita.</p>
